...
export default class BoardGrpcServer {
  ...
  public async getComment(
    ...
    const data = await this.boardCommentService.getCommentPage(
      boardIdxReq,
      pagingReq,
    );
  ...
  public async addComment(
    req: AuthRequest<GrpcUpsertCommentRequest>,
    ...
    // 데이터 추가
    const data = await this.boardCommentService.addComment(
      userData,
      boardIdxReq,
      upsertCommentReq,
    );
  ...
  public async getCommentReplies(
    ...
    const data = await this.boardCommentService.getCommentRepliesPage(
      commentIdxReq,
      pagingReq,
    );
  ...
  public async updateComment(
    ...
    // 데이터 수정
    const data = await this.boardCommentService.updateComment(
      userData,
      commentIdxReq,
      upsertCommentReq,
    );
  ...
  public async deleteComment(
    req: AuthRequest<GrpcCommentIdxRequest>,
    ...
    const data = await this.boardCommentService.deleteComment(
      userData,
      commentIdxReq,
    );
